...
parser.add_argument("-b", "--budget", help="budget for optimization step, no budget constraint when less or equal to 0", required=True)
...
new_graph = taso.optimize(graph, alpha = 1.0, budget = args.budget, print_subst = True)
